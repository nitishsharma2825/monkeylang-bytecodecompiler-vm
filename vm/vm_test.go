...
import (
	"fmt"
	"practice/nitish/monkey/ast"
	"practice/nitish/monkey/compiler"
	"practice/nitish/monkey/lexer"
	"practice/nitish/monkey/object"
	"practice/nitish/monkey/parser"
	"testing"
)
...
func TestFunctionsWithoutReturnStatements(t *testing.T) {
	tests := []vmTestCase{
		{
			input: `
			let noReturn = fn() { };
